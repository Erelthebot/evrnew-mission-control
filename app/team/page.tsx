  ...
  return (
    <div className="px-5 py-6 max-w-6xl mx-auto space-y-10">
      ...
      <section>
        ...
        <p className="text-slate-500 text-xs mb-4">Original 8 specialized marketing agents orchestrated by CrewAI, running 24/7 on the ErelMastersMBP cluster node.</p>
