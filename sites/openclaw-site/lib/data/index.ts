...
export const teamMembers: TeamMember[] = [
  ...
  // AI Operations Team (Mission Control agents)
  {
    ...
    workload: 'heavy',
    model: 'grok-3 + Llama-3.3-70B-4bit (:52415) + Holo3-35B-A3B',
    tools: ['All MCP servers', 'xAI API', 'local cluster :52415', 'llama-server :8080'],
  },
  {
    id: 'tm9',
    name: 'Sales Agent',
  ...
  },
  {
    ...
    workload: 'normal',
    model: 'grok-3',
    tools: ['xAI API', 'Gmail API', 'Memory MCP'],
  },
  {
    id: 'tm15',
...
export const systemAgents: SystemAgent[] = [
  {
    ...
    llm: 'grok-3',
    tools: ['DataForSEO SERP API', 'Facebook Ad Library', 'Brave Search', 'BrowserBase', 'xAI API'],
  ...
  },
  {
    ...
    llm: 'Llama-3.3-70B-Instruct-4bit (:52415)',
    tools: ['mlx-cluster-proxy', 'DataForSEO', 'Google Search Console'],
  ...
  },
  {
    ...
    llm: 'Llama-3.3-70B-Instruct-4bit (:52415)',
    tools: ['mlx-cluster-proxy', 'Filesystem MCP'],
  ...
  },
  {
    ...
    llm: 'Holo3-35B-A3B + grok-3 + Llama-3.3-70B-4bit',
    tools: ['consensus.py (Holo3 :8080 + xAI + :52415)', 'Competitive Intel Data'],
  ...
  },
  {
    ...
    llm: 'grok-3',
    tools: ['xAI API', 'DataForSEO', 'Google Search Console'],
...
export const systemServices: SystemService[] = [
  { id: 'ss1', name: 'OpenClaw Gateway', description: 'ai.openclaw.gateway — Erel AI agent on port 18789. Telegram @theErelbot. Filter proxy :18799. Model: grok-3 (pinned). Execution via claude_task MCP only.', status: 'online', lastChecked: '2026-05-18T00:00:00Z', endpoint: 'http://localhost:18789', uptime: '99.9%' },
  ...
  { id: 'ss3b', name: 'llama-server (Holo3 vision)', description: 'Holo3-35B-A3B Q4_K_M on port 8080. Vision/GUI only — screen agents and consensus panel vision leg. Not the execution planner.', status: 'online', lastChecked: '2026-05-18T00:00:00Z', endpoint: 'http://localhost:8080', uptime: '99.0%' },
  { id: 'ss4a', name: 'mlx-cluster-proxy', description: 'OpenAI-compatible unified endpoint :52415. Interim: forwards to master mlx_lm.server :52416. Target: native exo cluster (TB5 RDMA). Reasoning, overflow, consensus synthesis.', status: 'online', lastChecked: '2026-05-18T00:00:00Z', endpoint: 'http://localhost:52415', uptime: '99.0%' },
  { id: 'ss4', name: 'mlx_lm.server (master)', description: 'Backend for cluster proxy — mlx_lm.server on port 52416. Model: mlx-community/Llama-3.3-70B-Instruct-4bit (~38GB). com.erel.mlx-server LaunchAgent.', status: 'online', lastChecked: '2026-05-18T00:00:00Z', endpoint: 'http://localhost:52416', uptime: '99.0%' },
  { id: 'ss4b', name: 'exo cluster (worker)', description: 'erel_worker@192.168.100.2 (TB5 bridge0). Target runtime for pooled inference; install blocked on Xcode Metal Toolchain + reboot. Worker mlx entry disabled in proxy interim.', status: 'pending', lastChecked: '2026-05-18T00:00:00Z', endpoint: 'http://192.168.100.2:52415', uptime: '—' },
  { id: 'ss4c', name: 'Ollama (embeddings)', description: 'nomic-embed-text on port 11435. Embeddings/RAG only. Port 11434 intentionally unused.', status: 'online', lastChecked: '2026-05-18T00:00:00Z', endpoint: 'http://localhost:11435', uptime: '99.0%' },
...
export const integrations: Integration[] = [
  { name: 'xAI Grok API', purpose: 'Primary tier — grok-3 pinned. Chat, copy, ads, monitoring, Telegram, Hermes default, site chat.', status: 'active' },
  { name: 'Local cluster (:52415)', purpose: 'Reasoning, overflow, consensus synthesis, site-chat fallback. Llama-3.3-70B-Instruct-4bit via mlx-cluster-proxy → mlx_lm.server (exo target).', status: 'active' },
  { name: 'llama-server (Holo3)', purpose: 'Vision/GUI only — Holo3-35B-A3B on port 8080. Not used for text planning.', status: 'active' },
  { name: 'Google Gemini API', purpose: 'Image generation only — gemini-3.1-flash-image-preview. Not used for text or reasoning.', status: 'active' },
  { name: 'OpenRouter API', purpose: 'Reserved — key in .env; not in hot path since 2026-05-18. DeepSeek-V4-Flash deferred (148GB > 96GB pooled).', status: 'active' },
  { name: 'Ollama (embeddings)', purpose: 'nomic-embed-text embeddings only — port 11435. NOT in inference chain.', status: 'active' },
