...
const agents = [
  {
    ...
    tools: ['DataForSEO', 'FB Ad Library', 'Google Search', 'xAI'],
  ...
  },
  {
    ...
    tools: ['xAI', 'Google Ads API', 'Meta API'],
    outputDir: 'data/ads/',
    accentColor: '#f59e0b',
  },
  {
  ...
  },
  {
    ...
    llm: 'consensus (Holo3+Grok+DeepSeek)',
    lastRun: 'Mon Apr 20, 8:00 AM',
    ...
    tools: ['consensus.py', 'Holo3-35B', 'Grok-3', 'DeepSeek-V4-Flash'],
  ...
  },
  {
    ...
    tools: ['Telegram API', 'xAI', 'OpenClaw'],
