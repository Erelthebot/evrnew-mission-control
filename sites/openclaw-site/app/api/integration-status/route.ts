...
const ENV_INTEGRATIONS = [
  { name: 'Google Gemini',         purpose: 'Reasoning & synthesis tier — strategy, content, consensus engine', envKey: 'GEMINI_API_KEY', category: 'AI' },
  { name: 'xAI Grok',              purpose: 'Fast inference tier — conversational, real-time, monitoring',      envKey: 'XAI_API_KEY',    category: 'AI' },
