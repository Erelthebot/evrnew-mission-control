...
export const systemServices: SystemService[] = [
  ...
  { id: 'ss3', name: 'Mission Control', description: 'Next.js 15 app — this dashboard. Running via com.evrnew.mission-control launchd on port 3003.', status: 'online', lastChecked: '2026-03-11T00:00:00Z', endpoint: 'http://localhost:3003', uptime: '100%' },
